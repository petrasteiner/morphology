...
Petra C. Steiner, University of Hildesheim,        
...
This is a simple Perl script for the conversion of CELEX GML.CD to a modernized version.                  
 ...
 4. Start the program by "perl OrthCELEX.pl"                 
                                                             
  Input Files:                                               
  GML.CD and GOL.CD of the CELEX database                    
  within the same folder                                     
                                                             
 Files generated:                                            
 GMOLoutputintermediate: revised umlauts and sz of lemmas    
 GMOLout: above plus revised morphological analyses          
 GMOLoutneworthography: GMOL transformed to modern spelling  
 ...
 MLhash  GMOLintermediatehash  GMOLoutputhash                
 GMOLoutputreformedhash  GOLhash                             
...
use lib "/home/steinerp/programs/Perl/perllib/";
...
$smorphhashFilename = "GMLhash";

# if GMLhash has been generated use this file (later: no consequences)

if (-e $smorphhashFilename)
{
    print "\n Loading hash file of GML\n";
